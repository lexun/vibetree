...
impl EnvFileGenerator {
    ...
    fn build_env_content(_branch_name: &str, values: &HashMap<String, u16>) -> String {
...
mod tests {
    ...
    fn test_generate_env_file() -> Result<()> {
        ...
        values.insert("PGPORT".to_string(), 5433);
        values.insert("REDIS_PORT".to_string(), 6380);
        values.insert("API_PORT".to_string(), 8001);
    ...
    fn test_custom_env_file_path() -> Result<()> {
        ...
        let mut values = HashMap::new();
        values.insert("API_PORT".to_string(), 8080);
